...
def report(db_path: str = DB_DEFAULT, trials: int = 20000) -> dict:
    ...
    print("=" * 78)
    print("  OPEN, not established: whether the apertures are a graded series.")
    print("  Avenches beats 83 % of random sets on linearity - p = 0.17, not")
    print("  significant, but not nothing. One twelve-aperture specimen gives")
    print("  no power to decide it either way.")
    print()
    print("  OPEN, not established: whether two examples agree. The single")
    print("  comparison available is Mainz 3 - four apertures spanning 3 mm -")
    print("  against Avenches, and it is close to vacuous.")
    print()
    ...
    print()
    print("  THE REAL RESULT IS THE EVIDENCE GAP. One specimen in forty has a")
    print("  full set of measured apertures. The gauge-former asymmetry in")
    print("  RDORP-012 6.1 rests on scoring, and this computation supports")
    print("  only part of it. Measuring all twelve apertures on one complete")
    print("  specimen - RDORP-013 item B2, an afternoon with a ruler and a")
    print("  lens - would settle the rest.")
