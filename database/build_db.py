...
SPECIMEN_QUALITY = [
    ...
    ("RD-0042", "unknown", "D", "none", 0, 0, 1, 0,
     "Findspot only, from PUB-0050 at two removes. Admitted for context because a findspot is recorded and provenance is D; contributes to distribution and to nothing else"),
    ("RD-0043", "unknown", "D", "none", 0, 0, 1, 0,
     "Findspot only, from PUB-0050 at two removes. Admitted for context because a findspot is recorded and provenance is D; contributes to distribution and to nothing else"),
    ("RD-0044", "unknown", "D", "none", 0, 0, 1, 0,
     "Findspot only, from PUB-0050 at two removes. Admitted for context because a findspot is recorded and provenance is D; contributes to distribution and to nothing else"),
    ("RD-0045", "unknown", "D", "none", 0, 0, 1, 0,
     "Findspot only, from PUB-0050 at two removes. Admitted for context because a findspot is recorded and provenance is D; contributes to distribution and to nothing else"),
    ("RD-0046", "unknown", "D", "none", 0, 0, 1, 0,
     "Findspot only, from PUB-0050 at two removes. Admitted for context because a findspot is recorded and provenance is D; contributes to distribution and to nothing else"),
    ("RD-0047", "unknown", "D", "none", 0, 0, 1, 0,
     "Findspot only, from PUB-0050 at two removes. Admitted for context because a findspot is recorded and provenance is D; contributes to distribution and to nothing else"),
    ("RD-0048", "unknown", "D", "none", 0, 0, 1, 0,
     "Findspot only, from PUB-0050 at two removes. Admitted for context because a findspot is recorded and provenance is D; contributes to distribution and to nothing else"),
    ("RD-0049", "unknown", "D", "none", 0, 0, 1, 0,
     "Findspot only, from PUB-0050 at two removes. Admitted for context because a findspot is recorded and provenance is D; contributes to distribution and to nothing else"),
    ("RD-0050", "unknown", "D", "none", 0, 0, 1, 0,
     "Findspot only, from PUB-0050 at two removes. Admitted for context because a findspot is recorded and provenance is D; contributes to distribution and to nothing else"),
    ("RD-0051", "unknown", "D", "none", 0, 0, 1, 0,
     "Findspot only, from PUB-0050 at two removes. Admitted for context because a findspot is recorded and provenance is D; contributes to distribution and to nothing else"),
    ("RD-0052", "unknown", "D", "none", 0, 0, 1, 0,
     "Findspot only, from PUB-0050 at two removes. Admitted for context because a findspot is recorded and provenance is D; contributes to distribution and to nothing else"),
    ("RD-0053", "unknown", "D", "none", 0, 0, 1, 0,
     "Findspot only, from PUB-0050 at two removes. Admitted for context because a findspot is recorded and provenance is D; contributes to distribution and to nothing else"),
    ("RD-0054", "unknown", "D", "none", 0, 0, 1, 0,
     "Findspot only, from PUB-0050 at two removes. Admitted for context because a findspot is recorded and provenance is D; contributes to distribution and to nothing else"),
    ("RD-0055", "unknown", "D", "none", 0, 0, 1, 0,
     "Findspot only, from PUB-0050 at two removes. Admitted for context because a findspot is recorded and provenance is D; contributes to distribution and to nothing else"),
    ("RD-0056", "unknown", "D", "none", 0, 0, 1, 0,
     "Findspot only, from PUB-0050 at two removes. Admitted for context because a findspot is recorded and provenance is D; contributes to distribution and to nothing else"),
    ("RD-0057", "unknown", "D", "none", 0, 0, 1, 0,
     "Findspot only, from PUB-0050 at two removes. Admitted for context because a findspot is recorded and provenance is D; contributes to distribution and to nothing else"),
...
EXPERIMENTS = [
    ...
    ("EXP-0011", "H002; C-01; C-03; C-11; C-13",
     ...
     "object MEASURES: artillery shot (C-01), net mesh (C-03), dividers or "
     "angles (C-11), garment sizes (C-13) and range (H002). RDORP-012 6.1 "
     "reports that every gauge reading is punished by the evidence and calls "
     "it the gauge-former asymmetry, but that finding rests on scoring. A "
     "gauge needs three things and all five readings need all three: a graded "
     "series of sizes, reproducibility between examples, and divisions a user "
     "can tell apart.",
     "Analytical computation at database/exp_gauge.py, tested at "
     "database/test_exp_gauge.py. (a) GRADED SERIES: least-squares line "
     "through the sorted aperture diameters, RMS residual normalised by the "
     "range. THE NULL IS ESSENTIAL - the order statistics of a uniform sample "
     "are evenly spaced in expectation, so sorting alone manufactures a "
     "progression; the control is 20000 random diameter sets of the same size "
     "put through the same fit, seeded. (b) REPRODUCIBILITY: normalise two "
     "specimens' series to [0,1] and take the mean absolute difference, "
     "against a null of two unrelated sorted sets, because normalising forces "
     "the endpoints to agree. (c) DISTINGUISHABILITY: smallest step between "
     "neighbouring apertures against 1 mm, a generous limit for separating two "
     "openings by eye. (d) C-01 SPECIFICALLY: aperture diameters against the "
     "diameters of lead glandes of 20 to 60 g at lead's density.",
     "TWO RESULTS ESTABLISHED, TWO QUESTIONS LEFT OPEN, AND THE OPEN ONES ARE "
     "THE POINT. "
     "ESTABLISHED: the object cannot be READ as a gauge. On both specimens "
     "carrying four or more measured apertures the smallest step between "
     "neighbours is at or below a millimetre - Avenches 0.30 mm, Mainz 3 "
     "0.00 mm with two apertures of identical recorded diameter. A user could "
     "not tell which opening a thing had passed. A gauge whose divisions "
     "cannot be told apart reports nothing, whatever series it follows. "
     "ESTABLISHED: no specimen carries an opening AT a lead-shot calibre. "
     "Glandes of 20, 30, 40, 50 and 60 g are 15.0, 17.2, 18.9, 20.3 and 21.6 "
     "mm across; the apertures produce near-misses of the kind any spread "
     "produces. C-01 fails directly. "
     "OPEN: whether the apertures form a graded series. Avenches beats 83 per "
     "cent of random sets on linearity, p = 0.17 - not significant and not "
     "nothing. OPEN: whether two examples agree. The single comparison "
     "available is Mainz 3, four apertures spanning 3 mm, against Avenches; "
     "it disagrees by 0.053 where unrelated sets average 0.103, p = 0.17. "
     "Neither question has the evidence to be decided.",
     "THE REAL RESULT IS THE EVIDENCE GAP, AND IT REVISES A CLAIM. ONE "
     "SPECIMEN IN FORTY carries a full set of twelve measured apertures. The "
     "gauge-former asymmetry reported in RDORP-012 6.1 is a scoring result; "
     "this computation supports the part about readability and the shot "
     "calibres, and CANNOT support the part about irregularity, which the "
     "document should therefore not assert as computed. "
     "Measuring all twelve apertures on one complete specimen - RDORP-013 "
     "item B2, an afternoon with a ruler and a lens - would decide both open "
     "questions at once. This experiment raises B2's value: it was listed as "
     "the cheapest decisive test in the project and is now shown to be the "
     "only route to two findings the project currently states more strongly "
     "than it can support."),

    ("EXP-0010", "C-05",
     "Test whether a dodecahedron could serve as a volumetric measure for "
     "grain or liquid. C-05 was eliminated in the screen at -18.0 on a "
     "standardisation argument - a measure that varies between examples "
     "measures nothing - which is an argument about the corpus rather than "
     "about the object, produced by a screen rule known to be crude (A7). "
     "This tests the candidate on its own terms.",
     "Analytical computation at database/exp_volume.py, tested at "
     "database/test_exp_volume.py. Three questions. "
     "(a) NOMINAL CAPACITY: the cavity of a uniform shell is a similar "
     "dodecahedron whose inradius is reduced by the wall thickness; "
     "V = (15 + 7 sqrt5)/4 a^3 and inradius = sqrt(250 + 110 sqrt5)/20 a. "
     "Compute the enclosed volume for every measured specimen and find the "
     "nearest Roman capacity unit. THE NULL MATTERS: Roman units are roughly "
     "geometric, so any volume in range sits within some percentage of one. "
     "The control is 200000 volumes drawn uniformly in LOG space over the "
     "same range, seeded. "
     "(b) RETAINED CAPACITY: how much the object holds when set down. "
     "(c) GRANULARITY: aperture diameter against cereal grain length.",
     "REFUTED ON THE FORM, NOT ON THE CORPUS, AND MORE DECISIVELY THAN THE "
     "SCREEN MANAGED. "
     "(a) Nominal capacity runs 42.8 ml (Couthuin, 44 mm) to 1297.7 ml "
     "(Fishguard, 127.7 mm and rejected for geometry), a factor of 30 across "
     "the measured corpus. The mean relative distance to the nearest Roman "
     "unit is 24.8 per cent, against 23.0 per cent for log-uniform random "
     "volumes; 65 per cent of random volumes sit at least as close. NOMINAL "
     "CAPACITY IS NO BETTER THAN CHANCE, and the apparent near-matches "
     "(Norton Disney +9 per cent of a hemina, Couthuin +6 per cent of a "
     "cyathus) are what any object of this size would produce. "
     "(b) THE DECISIVE RESULT: every face carries an aperture at its centre, "
     "so whichever face is downward its aperture is the lowest point of the "
     "cavity. RETAINED VOLUME IS ZERO IN EVERY ORIENTATION, for every "
     "specimen, as a property of the form. A measure must retain what it "
     "measures. "
     "(c) Cereal grain is 5 to 9 mm long and the published aperture range is "
     "6 to 40 mm, so every aperture passes grain freely. Dry measure fails "
     "for the same reason as liquid.",
     "THIS CORRECTS AN ARITHMETIC ERROR MADE WHILE SCOPING THE EXPERIMENT. A "
     "first estimate used a volume coefficient of 2.785 rather than the "
     "correct 7.663, understating every volume by a factor of about 2.75 and "
     "making the object look far too small to be any Roman unit. It is not "
     "too small; the volumes land squarely among the units, and it is only "
     "the null that shows the fit is meaningless. A test guards the "
     "coefficient. "
     "THE SCREEN'S ORIGINAL GROUND IS WEAKER THAN THIS ONE. Standardisation "
     "is an argument about variation between examples; retention is an "
     "argument about whether the object can perform the function at all. "
     "C-05 should be recorded as eliminated by computation, not by score."),

    ("EXP-0009", "H006; C-14; C-15",
     "Test whether the set of face-axis elevations a dodecahedron can present "
     "fits the twelve zodiac sign boundaries better than an arbitrary set of "
     "elevations would. This is separate from EXP-0002 and EXP-0003, which "
     "refute the solar readings on resolution and on the number of reachable "
     "elevations; here the question is whether the APPARENT fit that motivates "
     "the reading is anything more than the freedom to choose a latitude.",
     "Analytical computation with a Monte Carlo control, at "
     "database/exp_zodiac.py, tested at database/test_exp_zodiac.py. "
     "(a) Derive the solid from first principles and take the seven distinct "
     "face-axis elevations across all modes of support, as EXP-0003. "
     "(b) At latitude phi the solar noon altitude is 90 - phi + declination; "
     "invert for each elevation to get the declination, then invert "
     "sin(dec) = sin(obliquity) sin(longitude) to get the two solar longitudes "
     "per year at which it occurs. Each is an event. "
     "(c) Measure each event's distance to the nearest multiple of 30 degrees. "
     "The fit statistic is the mean over all events; lower is a closer fit. "
     "(d) Scan latitude from 40 to 58 N, the range the corpus covers, and keep "
     "the best. (e) Compare against chance. The analytic baseline is exact: "
     "distance from a uniform longitude to the nearest boundary is uniform on "
     "[0, 15], mean 7.5 degrees. The controlling comparison is a Monte Carlo "
     "of 20000 RANDOM elevation sets of the same size given the same free "
     "latitude scan, seeded for reproducibility.",
     "THE FIT IS NOT BETTER THAN CHANCE; IT IS WORSE. The best mean distance "
     "to a sign boundary is 5.52 degrees, at 58.0 N over 8 events. That beats "
     "the 7.5 degree analytic baseline, but the beating is an artefact of the "
     "scan: a free latitude search is a maximisation over a nuisance "
     "parameter and will beat 7.5 for almost any elevation set. Against the "
     "controlling comparison, 18810 of 19997 random elevation sets do AT "
     "LEAST AS WELL (p = 0.94), and the median random set scores 3.51 degrees "
     "against the real solid's 5.52. The dodecahedron's elevations are, if "
     "anything, unusually badly placed for marking sign boundaries. "
     "THE OPTIMUM ALSO SITS AT THE EDGE OF THE SCANNED RANGE, which is a "
     "second sign that it is a boundary artefact and not an alignment.",
     "SUPERSEDES AN UNCOMMITTED CALCULATION. An earlier version of RDORP-012 "
     "stated a best mean distance of 5.84 degrees at 51.8 N against 7.50 "
     "expected at random. That figure had been computed once in a scratch "
     "session and the code was never committed, so it was removed from the "
     "document as unreproducible. This experiment replaces it. The replacement "
     "does not reproduce 5.84 at 51.8 N - it finds 5.52 at 58.0 N - and the "
     "discrepancy cannot be resolved, because the original method is not "
     "recoverable. THE CONCLUSION IS UNCHANGED AND NOW STRONGER: the earlier "
     "figure was compared only against the analytic 7.5, which the free scan "
     "guarantees beating; the Monte Carlo control shows the fit is worse than "
     "an arbitrary solid's. "
     "THE TEST IS CHECKED FOR SENSITIVITY: a contrived elevation set placed "
     "deliberately on sign boundaries scores 0.0000 degrees, so the statistic "
     "does distinguish a real alignment from a random one."),
...
def build_database():
    ...
    SPECIMENS = [
        ...
        # --- Wagemans chart 1: findspots absent from the corpus ---
        # Sixteen findspot-only records at confidence D. See PUB-0050.
        ("RD-0041", "Bad Cannstatt dodecahedron",
         "Bad Cannstatt, Stuttgart", "Germany", "Germania superior",
         "Unknown", None, None,
         None, None, None,
         None,
         "Copper alloy", None,
        ...
        ("RD-0042", "Bonn dodecahedron",
         ...
         None, "PUB-0050", "D", None, None,
         "PUB-0050 chart 1, which lists 29 findspots with measuring periods and no measurements. FINDSPOT ONLY, AT TWO REMOVES: Wagemans is a self-published secondary source and does not give the original find report. Recorded to improve the distribution evidence, which is where this corpus is weakest; contributes nothing to any geometric or context variable. A primary source is needed before this specimen supports anything else. No further detail is published for this findspot."),
        ("RD-0043", "Heidesheim dodecahedron",
         "Heidesheim am Rhein", "Germany", "Germania superior",
         "Unknown", None, None,
         None, None, None,
         None,
         "Copper alloy", None,
         ...
         None, "PUB-0050", "D", None, None,
         "PUB-0050 chart 1, which lists 29 findspots with measuring periods and no measurements. FINDSPOT ONLY, AT TWO REMOVES: Wagemans is a self-published secondary source and does not give the original find report. Recorded to improve the distribution evidence, which is where this corpus is weakest; contributes nothing to any geometric or context variable. A primary source is needed before this specimen supports anything else. No further detail is published for this findspot."),
        ("RD-0044", "Marnheim dodecahedron",
         "Marnheim, Donnersbergkreis", "Germany", "Germania superior",
         "Unknown", None, None,
         None, None, None,
         None,
         "Copper alloy", None,
         ...
         None, "PUB-0050", "D", None, None,
         "PUB-0050 chart 1, which lists 29 findspots with measuring periods and no measurements. FINDSPOT ONLY, AT TWO REMOVES: Wagemans is a self-published secondary source and does not give the original find report. Recorded to improve the distribution evidence, which is where this corpus is weakest; contributes nothing to any geometric or context variable. A primary source is needed before this specimen supports anything else. No further detail is published for this findspot."),
        ("RD-0045", "Mombach dodecahedron",
         "Mombach, Mainz", "Germany", "Germania superior",
         "Unknown", None, None,
         None, None, None,
         None,
         "Copper alloy", None,
         ...
         None, "PUB-0050", "D", None, None,
         "PUB-0050 chart 1, which lists 29 findspots with measuring periods and no measurements. FINDSPOT ONLY, AT TWO REMOVES: Wagemans is a self-published secondary source and does not give the original find report. Recorded to improve the distribution evidence, which is where this corpus is weakest; contributes nothing to any geometric or context variable. A primary source is needed before this specimen supports anything else. No further detail is published for this findspot."),
        ("RD-0046", "Besancon dodecahedron",
         "Besancon (Vesontio)", "France", "Maxima Sequanorum",
         "Unknown", None, None,
         None, None, None,
         None,
         "Copper alloy", None,
         ...
         None, "PUB-0050", "D", None, None,
         "PUB-0050 chart 1, which lists 29 findspots with measuring periods and no measurements. FINDSPOT ONLY, AT TWO REMOVES: Wagemans is a self-published secondary source and does not give the original find report. Recorded to improve the distribution evidence, which is where this corpus is weakest; contributes nothing to any geometric or context variable. A primary source is needed before this specimen supports anything else. No further detail is published for this findspot."),
        ("RD-0047", "Poitiers dodecahedron",
         "Poitiers (Limonum)", "France", "Aquitania",
         "Unknown", None, None,
         None, None, None,
         None,
         "Copper alloy", None,
         ...
         None, "PUB-0050", "D", None, None,
         "PUB-0050 chart 1, which lists 29 findspots with measuring periods and no measurements. FINDSPOT ONLY, AT TWO REMOVES: Wagemans is a self-published secondary source and does not give the original find report. Recorded to improve the distribution evidence, which is where this corpus is weakest; contributes nothing to any geometric or context variable. A primary source is needed before this specimen supports anything else. No further detail is published for this findspot."),
        ("RD-0048", "La Perouse-Mornay dodecahedron",
         "La Perouse-Mornay", "France", None,
         "Unknown", None, None,
         None, None, None,
         None,
         "Copper alloy", None,
         ...
         None,
         None, "PUB-0050", "D", None, None,
         "PUB-0050 chart 1, which lists 29 findspots with measuring periods and no measurements. FINDSPOT ONLY, AT TWO REMOVES: Wagemans is a self-published secondary source and does not give the original find report. Recorded to improve the distribution evidence, which is where this corpus is weakest; contributes nothing to any geometric or context variable. A primary source is needed before this specimen supports anything else. PLACENAME NOT RESOLVED. Recorded as PUB-0050 gives it; no French commune of this exact name has been confirmed, so the findspot may be a compound or a misrendering and should be checked against a primary source before it is relied on"),
        ("RD-0049", "Clement dodecahedron",
         "'Clement', France", "France", None,
         "Unknown", None, None,
         None, None, None,
         None,
         "Copper alloy", None,
         ...
         None,
         None, "PUB-0050", "D", None, None,
         "PUB-0050 chart 1, which lists 29 findspots with measuring periods and no measurements. FINDSPOT ONLY, AT TWO REMOVES: Wagemans is a self-published secondary source and does not give the original find report. Recorded to improve the distribution evidence, which is where this corpus is weakest; contributes nothing to any geometric or context variable. A primary source is needed before this specimen supports anything else. PLACENAME NOT RESOLVED. PUB-0050 gives only 'Clement'; possibly Saint-Clement, of which several exist. Not usable for distribution at any finer grain than 'France' until checked"),
        ("RD-0050", "Conches-dessous dodecahedron",
         "Conches-dessous, Bern", "Switzerland", "Germania superior",
         "Unknown", None, None,
         None, None, None,
         None,
         "Copper alloy", None,
         ...
         None, "PUB-0050", "D", None, None,
         "PUB-0050 chart 1, which lists 29 findspots with measuring periods and no measurements. FINDSPOT ONLY, AT TWO REMOVES: Wagemans is a self-published secondary source and does not give the original find report. Recorded to improve the distribution evidence, which is where this corpus is weakest; contributes nothing to any geometric or context variable. A primary source is needed before this specimen supports anything else. No further detail is published for this findspot."),
        ("RD-0051", "Radelfingen dodecahedron",
         "Radelfingen, Bern", "Switzerland", "Germania superior",
         "Unknown", None, None,
         None, None, None,
         None,
         "Copper alloy", None,
         ...
         None, "PUB-0050", "D", None, None,
         "PUB-0050 chart 1, which lists 29 findspots with measuring periods and no measurements. FINDSPOT ONLY, AT TWO REMOVES: Wagemans is a self-published secondary source and does not give the original find report. Recorded to improve the distribution evidence, which is where this corpus is weakest; contributes nothing to any geometric or context variable. A primary source is needed before this specimen supports anything else. No further detail is published for this findspot."),
        ("RD-0052", "Windisch (Vindonissa) dodecahedron",
         "Windisch (Vindonissa), Aargau", "Switzerland", "Germania superior",
         "Unknown", None, None,
         None, None, None,
         None,
         "Copper alloy", None,
         ...
         None,
         None, "PUB-0050", "D", None, None,
         "PUB-0050 chart 1, which lists 29 findspots with measuring periods and no measurements. FINDSPOT ONLY, AT TWO REMOVES: Wagemans is a self-published secondary source and does not give the original find report. Recorded to improve the distribution evidence, which is where this corpus is weakest; contributes nothing to any geometric or context variable. A primary source is needed before this specimen supports anything else. Legionary fortress. A context category may well be recoverable from the Vindonissa excavation literature, which is extensive"),
        ("RD-0053", "Zurich dodecahedron",
         "Zurich (Turicum)", "Switzerland", "Germania superior",
         "Unknown", None, None,
         None, None, None,
         None,
         "Copper alloy", None,
         ...
         None, "PUB-0050", "D", None, None,
         "PUB-0050 chart 1, which lists 29 findspots with measuring periods and no measurements. FINDSPOT ONLY, AT TWO REMOVES: Wagemans is a self-published secondary source and does not give the original find report. Recorded to improve the distribution evidence, which is where this corpus is weakest; contributes nothing to any geometric or context variable. A primary source is needed before this specimen supports anything else. No further detail is published for this findspot."),
        ("RD-0054", "Hartwerd dodecahedron",
         "Hartwerd, Sudwest-Fryslan, Friesland", "Netherlands", None,
         "Unknown", None, None,
         None, None, None,
         None,
         "Copper alloy", None,
         ...
         None,
         None, "PUB-0050", "D", None, None,
         "PUB-0050 chart 1, which lists 29 findspots with measuring periods and no measurements. FINDSPOT ONLY, AT TWO REMOVES: Wagemans is a self-published secondary source and does not give the original find report. Recorded to improve the distribution evidence, which is where this corpus is weakest; contributes nothing to any geometric or context variable. A primary source is needed before this specimen supports anything else. BEYOND THE LIMES. Hartwerd lies in Frisia, north of the Rhine frontier and outside the provinces, which makes it the only recorded findspot in the corpus from unconquered territory. PUB-0050 publishes an angle table for this specimen, so measurements exist and are not reproduced here; acquiring them is worth more than the findspot alone"),
        ("RD-0055", "Kenchester dodecahedron",
         "Kenchester (Magnis), Herefordshire", "United Kingdom", "Britannia",
         "Unknown", None, None,
         None, None, None,
         None,
         "Copper alloy", None,
         ...
         None, "PUB-0050", "D", None, None,
         "PUB-0050 chart 1, which lists 29 findspots with measuring periods and no measurements. FINDSPOT ONLY, AT TWO REMOVES: Wagemans is a self-published secondary source and does not give the original find report. Recorded to improve the distribution evidence, which is where this corpus is weakest; contributes nothing to any geometric or context variable. A primary source is needed before this specimen supports anything else. No further detail is published for this findspot."),
        ("RD-0056", "London dodecahedron",
         "London (Londinium)", "United Kingdom", "Britannia",
         "Unknown", None, None,
         None, None, None,
         None,
         "Copper alloy", None,
         ...
         None, "PUB-0050", "D", None, None,
         "PUB-0050 chart 1, which lists 29 findspots with measuring periods and no measurements. FINDSPOT ONLY, AT TWO REMOVES: Wagemans is a self-published secondary source and does not give the original find report. Recorded to improve the distribution evidence, which is where this corpus is weakest; contributes nothing to any geometric or context variable. A primary source is needed before this specimen supports anything else. No further detail is published for this findspot."),
        ("RD-0057", "Newcastle dodecahedron",
         "Newcastle upon Tyne (Pons Aelius)", "United Kingdom", "Britannia",
         "Unknown", None, None,
         None, None, None,
         None,
         "Copper alloy", None,
