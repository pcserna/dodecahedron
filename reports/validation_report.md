...
| `page-missing` | observation 111 | RD-0018 x EV025 cites PUB-0013 (Online), a source type that carries no pagination; record an identifier if the source offers one, otherwise this is a limit of the source, not of the extraction |
| `page-missing` | observation 112 | RD-0018 x EV031 cites PUB-0013 (Online), a source type that carries no pagination; record an identifier if the source offers one, otherwise this is a limit of the source, not of the extraction |
| `page-missing` | observation 220 | RD-0038 x EV001 cites PUB-0045 (Database), a source type that carries no pagination; record an identifier if the source offers one, otherwise this is a limit of the source, not of the extraction |
| `page-missing` | observation 221 | RD-0038 x EV025 cites PUB-0045 (Database), a source type that carries no pagination; record an identifier if the source offers one, otherwise this is a limit of the source, not of the extraction |
| `page-missing` | observation 222 | RD-0038 x EV029 cites PUB-0045 (Database), a source type that carries no pagination; record an identifier if the source offers one, otherwise this is a limit of the source, not of the extraction |
| `page-missing` | observation 223 | RD-0039 x EV025 cites PUB-0046 (Online), a source type that carries no pagination; record an identifier if the source offers one, otherwise this is a limit of the source, not of the extraction |
| `page-missing` | observation 224 | RD-0039 x EV030 cites PUB-0046 (Online), a source type that carries no pagination; record an identifier if the source offers one, otherwise this is a limit of the source, not of the extraction |
| `page-missing` | observation 230 | RD-0038 x EV004 cites PUB-0045 (Database), a source type that carries no pagination; record an identifier if the source offers one, otherwise this is a limit of the source, not of the extraction |
| `page-missing` | observation 232 | RD-0040 x EV014 cites PUB-0048 (Database), a source type that carries no pagination; record an identifier if the source offers one, otherwise this is a limit of the source, not of the extraction |
| `page-missing` | observation 233 | RD-0040 x EV041 cites PUB-0048 (Database), a source type that carries no pagination; record an identifier if the source offers one, otherwise this is a limit of the source, not of the extraction |
| `page-missing` | observation 49 | RD-0005 x EV001 cites PUB-0008 (Article), a source type that carries no pagination; record an identifier if the source offers one, otherwise this is a limit of the source, not of the extraction |
| `page-missing` | observation 50 | RD-0005 x EV002 cites PUB-0008 (Article), a source type that carries no pagination; record an identifier if the source offers one, otherwise this is a limit of the source, not of the extraction |
| `page-missing` | observation 51 | RD-0005 x EV011 cites PUB-0008 (Article), a source type that carries no pagination; record an identifier if the source offers one, otherwise this is a limit of the source, not of the extraction |
| `page-missing` | observation 52 | RD-0005 x EV017 cites PUB-0008 (Article), a source type that carries no pagination; record an identifier if the source offers one, otherwise this is a limit of the source, not of the extraction |
| `page-missing` | observation 53 | RD-0005 x EV018 cites PUB-0008 (Article), a source type that carries no pagination; record an identifier if the source offers one, otherwise this is a limit of the source, not of the extraction |
| `page-missing` | observation 54 | RD-0005 x EV025 cites PUB-0008 (Article), a source type that carries no pagination; record an identifier if the source offers one, otherwise this is a limit of the source, not of the extraction |
| `page-missing` | observation 55 | RD-0006 x EV025 cites PUB-0004 (Online), a source type that carries no pagination; record an identifier if the source offers one, otherwise this is a limit of the source, not of the extraction |
